...
void conc_rif(nodo_lista *&L1, nodo_lista *L2)
{	//PRE=(lista(L1) e lista(L2) sono corrette, lista(vL1)=lista(L1) e lista(vL2)=lista(L2)).
	if(!L1)
...
nodo_lista *f(nodo_albero *r, int y)
{	//PRE=(albero(r) corretto, albero(vr)=albero(r), y definito).
