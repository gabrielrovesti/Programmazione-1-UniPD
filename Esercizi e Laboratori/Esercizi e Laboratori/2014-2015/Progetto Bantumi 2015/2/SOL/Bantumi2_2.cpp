...
/*Versione Funzionante secondo le regole del pdf*/
#include<iostream>
#include<fstream>
using namespace std;
...
/*Bantumi V2 che implementa la cattura come prevista dalle regole del gioco http://mancala.wikia.com/wiki/Kalah */
