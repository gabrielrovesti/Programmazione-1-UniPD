...
in un ciclo intermedio, supponendo i=2 e j=3, se c'è un match nel pattern indicato
la funzione entra nel primo condizionale, imposta la variabile di controllo a false perché è la prima volta
...
se non trovassi più un match, azzero l'indice j della matrice più piccola e ricomincio, reimpostando i contatori
